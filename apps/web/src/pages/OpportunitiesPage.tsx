...
export default function OpportunitiesPage() {
  ...
  const LEAD_POLICY_TYPES: Record<string, string[]> = {
    ...
    'farm-ranch-services': ['Fencing', 'Barn/Outbuilding', 'Well/Irrigation', 'Land Management', 'Equipment Repair', 'Arena', 'Pasture Seeding', 'Custom'],
    'horse-trailer-services': ['Trailer Repair', 'Custom Build', 'Living Quarters', 'Flooring', 'Electrical', 'Axle/Suspension', 'Annual Service', 'Transport'],
    'travel-agent': ['Vacation Package', 'Cruise', 'Group Trip', 'Honeymoon', 'All-Inclusive', 'Business Travel', 'Adventure Tour', 'Custom Itinerary'],
