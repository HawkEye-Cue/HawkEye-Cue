  ...
  return (
    <div className="space-y-4">
      ...
      {showModal && selectedDay !== null && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 overflow-y-auto" style={{ paddingTop: '3.5rem', paddingBottom: 'calc(5rem + env(safe-area-inset-bottom, 0px))', paddingLeft: '0.75rem', paddingRight: '0.75rem' }} onClick={() => { setShowModal(false); setShowAddForm(false); }}>
          <div className="glass-card-strong w-full max-w-md mx-auto animate-scale-in relative" onClick={(e) => e.stopPropagation()}>
